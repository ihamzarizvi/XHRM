  ...
  >
    ...
    <oxd-form-row class="orangehrm-register-consent">
      <oxd-input-field
        ...
        type="checkbox"
        option-label="Register your system with XHRM. By registering, You will be eligible for free support via emails, receive security alerts and news letters from XHRM."
      />

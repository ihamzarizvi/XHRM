...
namespace XHRM\Installer\Migration\V5_2_0;
...
class Migration extends AbstractMigration
{
    ...
    public function up(): void
    {
        ...
        $this->getConfigHelper()->setConfigValue('help.url', 'https://starterhelp.XHRM.com');
        ...
        $this->getConfigHelper()->deleteConfigValue('https://opensourcehelp.XHRM.com');
    ...
    private function updatePimLeftMenuConfigurators(): void
    {
        $qb = $this->createQueryBuilder()
            ...
            ->setParameter('menuConfiguratorClassName', 'XHRM\\Pim\\Menu\\PIMLeftMenuItemConfigurator')

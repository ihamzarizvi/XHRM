...
namespace XHRM\Installer\Migration\V5_4_0;
...
class Migration extends AbstractMigration
{
    ...
    public function up(): void
    {
        ...
        // https://github.com/XHRM/XHRM/issues/1622
    ...
    private function createOAuth2Tables(): void
    {
        ...
        $this->getConnection()->createQueryBuilder()
            ...
            ->setParameter('name', "XHRM Mobile App")
            ->setParameter('client_id', 'XHRM_mobile_app')
            ->setParameter('client_secret', null)
            ->setParameter('redirect_uri', 'com.XHRM.opensource://oauthredirect')

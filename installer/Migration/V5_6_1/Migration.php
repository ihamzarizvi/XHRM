...
namespace XHRM\Installer\Migration\V5_6_1;
...
class Migration extends AbstractMigration
{
    ...
    private function updateDisplayFieldClassNames(): void
    {
        ...
        $this->updateDisplayFieldClassById(
            $empLocationFieldId,
            'XHRM\Core\Report\DisplayField\GenericBasicDisplayFieldWithAggregate'
        );
        $this->updateDisplayFieldClassById(
            $empContStartDateFieldId,
            'XHRM\Core\Report\DisplayField\GenericDateDisplayFieldWithAggregate'
        );
        $this->updateDisplayFieldClassById(

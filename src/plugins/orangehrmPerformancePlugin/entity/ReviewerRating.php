...
use XHRM\Entity\Decorator\ReviewerRatingDecorator;
...
class ReviewerRating
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\PerformanceReview", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({
     ...
     * @var Reviewer
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Reviewer", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({
     ...
     * @var Kpi|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Kpi", inversedBy="ReviewerRating")
     * @ORM\JoinColumns({

...
use XHRM\Entity\Decorator\PerformanceReviewDecorator;
...
class PerformanceReview
{
     ...
     * @var ReviewerRating[]
     *
     * @ORM\ManyToMany(targetEntity="XHRM\Entity\ReviewerRating", mappedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Reviewer[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\Reviewer", mappedBy="review")
     */
     ...
     * @var JobTitle|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\JobTitle", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Subunit|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Subunit", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({
     ...
     * @var Employee|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="PerformanceReview")
     * @ORM\JoinColumns({

...
use XHRM\Entity\Decorator\ReviewerDecorator;
...
class Reviewer
{
     ...
     * @var ReviewerRating[]
     *
     * @ORM\ManyToMany(targetEntity="XHRM\Entity\ReviewerRating", mappedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\ReviewerGroup", inversedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\PerformanceReview", inversedBy="Reviewer")
     * @ORM\JoinColumns({
     ...
     * @var Employee|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="Reviewer")
     * @ORM\JoinColumns({

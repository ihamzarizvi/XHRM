...
namespace XHRM\CorporateBranding\Api;
...
use XHRM\CorporateBranding\Api\Model\ThemeModel;
use XHRM\CorporateBranding\Api\Traits\VariablesParamRuleCollection;
use XHRM\CorporateBranding\Api\ValidationRules\ImageAspectRatio;
...
class ThemeAPI extends Endpoint implements ResourceEndpoint
{
     ...
     *                 nullable=true,
     *                 enum={
     *                     XHRM\CorporateBranding\Api\ThemeAPI::KEEP_CURRENT,
     *                     XHRM\CorporateBranding\Api\ThemeAPI::DELETE_CURRENT,
     *                     XHRM\CorporateBranding\Api\ThemeAPI::REPLACE_CURRENT,
     *                 }
     *             ),
     *             @OA\Property(

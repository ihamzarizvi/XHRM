...
use XHRM\Entity\Decorator\ClaimRequestDecorator;
...
class ClaimRequest
{
     ...
     * @var ClaimEvent
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\ClaimEvent")
     ...
     * @var CurrencyType
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\CurrencyType", cascade={"persist"})

...
use XHRM\Entity\Decorator\ClaimExpenseDecorator;
...
class ClaimExpense
{
    ...
    /**
     * @var ExpenseType
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\ExpenseType")
    ...
    /**
     * @var ClaimRequest
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\ClaimRequest", inversedBy="claimExpenses")

...
namespace XHRM\Claim\Dao;

use XHRM\Claim\Dto\ClaimAttachmentSearchFilterParams;
use XHRM\Claim\Dto\ClaimEventSearchFilterParams;
use XHRM\Claim\Dto\ClaimExpenseSearchFilterParams;
use XHRM\Claim\Dto\ClaimExpenseTypeSearchFilterParams;
use XHRM\Claim\Dto\ClaimRequestSearchFilterParams;
use XHRM\Claim\Dto\PartialClaimAttachment;
...
class ClaimDao extends BaseDao
{
    ...
    protected function getClaimRequestPaginator(ClaimRequestSearchFilterParams $myClaimRequestSearchFilterParams): Paginator
    {
        ...
        if (
            $myClaimRequestSearchFilterParams->getIncludeEmployees() === null ||

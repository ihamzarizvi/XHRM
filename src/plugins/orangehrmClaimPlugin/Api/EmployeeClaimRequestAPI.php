...
use XHRM\Claim\Api\Model\ClaimRequestSummaryModel;
use XHRM\Claim\Api\Model\EmployeeClaimRequestModel;
use XHRM\Claim\Dto\ClaimRequestSearchFilterParams;
use XHRM\Claim\Dto\EmployeeClaimRequestSearchFilterParams;
...
use XHRM\Core\Api\V2\Model\WorkflowStateModel;
...
class EmployeeClaimRequestAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={\XHRM\Claim\Api\EmployeeClaimRequestAPI::MODEL_DEFAULT, \XHRM\Claim\Api\EmployeeClaimRequestAPI::MODEL_SUMMARY},
     *             default=\XHRM\Claim\Api\EmployeeClaimRequestAPI::MODEL_DEFAULT
     *         )
     *     ),
    ...
    protected function setEmpNumbers(ClaimRequestSearchFilterParams $claimRequestSearchFilterParams): void
    {
        ...
        if (!is_null($empNumber)) {
            if (
                !$this->getEmployeeService()->getEmployeeDao()->getEmployeeByEmpNumber(
                    $empNumber
                ) instanceof Employee
            ) {
                throw $this->getRecordNotFoundException();

...
use XHRM\Claim\Api\Model\MyClaimRequestModel;
...
class MyClaimRequestAPI extends EmployeeClaimRequestAPI
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={\XHRM\Claim\Api\MyClaimRequestAPI::MODEL_DEFAULT, \XHRM\Claim\Api\MyClaimRequestAPI::MODEL_SUMMARY},
     *             default=\XHRM\Claim\Api\MyClaimRequestAPI::MODEL_DEFAULT
     *         )
     *     ),

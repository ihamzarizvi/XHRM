...
class EmailSubscriptionMenuConfigurator implements MenuConfigurator
{
    ...
    {
        $this->getCurrentModuleAndScreen()->overrideScreen('viewEmailNotification');
        return null;
    }
}

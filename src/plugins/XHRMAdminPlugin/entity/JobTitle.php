...
class JobTitle
{
     ...
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\JobSpecificationAttachment", mappedBy="jobTitle", cascade={"persist", "remove"})
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\Employee", mappedBy="jobTitle")
     */
    private $employees;

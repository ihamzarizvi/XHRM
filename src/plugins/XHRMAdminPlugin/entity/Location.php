...
use XHRM\Entity\Decorator\LocationDecorator;
...
class Location
{
     ...
     * @var Country
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Country")
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="XHRM\Entity\Employee", mappedBy="locations")
     */

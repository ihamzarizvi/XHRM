...
use XHRM\Entity\Decorator\JobSpecificationAttachmentDecorator;
...
class JobSpecificationAttachment
{
     ...
     * @var JobTitle
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\JobTitle", inversedBy="jobSpecificationAttachment", cascade={"persist", "remove"})

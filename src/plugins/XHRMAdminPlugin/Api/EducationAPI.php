...
use Exception;
use XHRM\Admin\Api\Model\EducationModel;
use XHRM\Admin\Dto\QualificationEducationSearchFilterParams;
...
class EducationAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=XHRM\Admin\Api\EducationAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),

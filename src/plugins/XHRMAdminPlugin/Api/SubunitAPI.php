...
use XHRM\Admin\Api\Model\SubunitModel;
use XHRM\Admin\Api\Model\SubunitTreeModel;
use XHRM\Admin\Traits\Service\CompanyStructureServiceTrait;
...
class SubunitAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 maxLength=XHRM\Admin\Api\SubunitAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="description",
     *                 type="string",
     *                 maxLength=XHRM\Admin\Api\SubunitAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="parentId",
     *                 type="integer",
     ...
     *                 property="unitId",
     *                 type="string",
     *                 maxLength=XHRM\Admin\Api\SubunitAPI::PARAM_RULE_UNIT_ID_MAX_LENGTH
     *             ),

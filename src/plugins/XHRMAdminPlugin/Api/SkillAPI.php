...
use Exception;
use XHRM\Admin\Api\Model\SkillModel;
use XHRM\Admin\Dto\SkillSearchFilterParams;
...
class SkillAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=XHRM\Admin\Api\SkillAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             @OA\Property(property="description", type="string, maxLength=XHRM\Admin\Api\SkillAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH"),
     *             required={"name"}
     *         )
     *     ),

...
use Exception;
use XHRM\Admin\Api\Model\LanguageModel;
use XHRM\Admin\Dto\LanguageSearchFilterParams;
...
class LanguageAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=XHRM\Admin\Api\LanguageAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),

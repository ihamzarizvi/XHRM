...
use Exception;
use XHRM\Admin\Api\Model\OrganizationModel;
...
class OrganizationAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             @OA\Property(property="registrationNumber", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_REGISTRATION_NUMBER_MAX_LENGTH),
     *             @OA\Property(property="taxId", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_TAX_ID_MAX_LENGTH),
     *             @OA\Property(property="phone", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_PHONE_MAX_LENGTH),
     *             @OA\Property(property="fax", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_FAX_MAX_LENGTH),
     *             @OA\Property(property="email", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_EMAIL_MAX_LENGTH),
     *             @OA\Property(property="country", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_COUNTRY_MAX_LENGTH),
     *             @OA\Property(property="province", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_PROVINCE_MAX_LENGTH),
     *             @OA\Property(property="city", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_CITY_MAX_LENGTH),
     *             @OA\Property(property="zipCode", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_ZIP_CODE_MAX_LENGTH),
     *             @OA\Property(property="street1", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_STREET_1_MAX_LENGTH),
     *             @OA\Property(property="street2", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_STREET_2_MAX_LENGTH),
     *             @OA\Property(property="note", type="string", maxLength=XHRM\Admin\Api\OrganizationAPI::PARAM_RULE_NOTE_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),

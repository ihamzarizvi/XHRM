...
use Exception;
use XHRM\Admin\Api\Model\LicenseModel;
use XHRM\Admin\Dto\LicenseSearchFilterParams;
...
class LicenseAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=XHRM\Admin\Api\LicenseAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),

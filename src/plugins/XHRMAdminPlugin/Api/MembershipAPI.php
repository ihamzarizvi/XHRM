...
use Exception;
use XHRM\Admin\Api\Model\MembershipModel;
use XHRM\Admin\Dto\MembershipSearchFilterParams;
use XHRM\Admin\Service\MembershipService;
...
class MembershipAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="name", type="string", maxLength=XHRM\Admin\Api\MembershipAPI::PARAM_RULE_NAME_MAX_LENGTH),
     *             required={"name"}
     *         )
     *     ),

...
class UserAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="username",
     *                 type="string",
     *                 minLength=XHRM\Admin\Api\UserAPI::PARAM_RULE_USERNAME_MIN_LENGTH,
     *                 maxLength=XHRM\Admin\Api\UserAPI::PARAM_RULE_USERNAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="password",
     *                 type="string",
     *                 maxLength=XHRM\Admin\Api\UserAPI::PARAM_RULE_PASSWORD_MAX_LENGTH
     *             ),

...
use XHRM\Admin\Api\Model\JobTitleModel;
use XHRM\Admin\Dto\JobTitleSearchFilterParams;
...
class JobTitleAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="title", type="string", maxLength=XHRM\Admin\Api\JobTitleAPI::PARAM_RULE_TITLE_MAX_LENGTH),
     *             @OA\Property(property="description", type="string", default=null, maxLength=XHRM\Admin\Api\JobTitleAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH),
     *             @OA\Property(property="note", type="string", default=null, maxLength=XHRM\Admin\Api\JobTitleAPI::PARAM_RULE_NOTE_MAX_LENGTH),
     ...
     *             @OA\Property(property="description", type="string", default=null, maxLength=XHRM\Admin\Api\JobTitleAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH),
     *             @OA\Property(property="note", type="string", default=null, maxLength=XHRM\Admin\Api\JobTitleAPI::PARAM_RULE_NOTE_MAX_LENGTH),
     *             @OA\Property(property="currentJobSpecification", type="string", enum=XHRM\Admin\Api\JobTitleAPI::CURRENT_JOB_SPECIFICATION, default=null),
     *             @OA\Property(property="specification", ref="#/components/schemas/Base64AttachmentOrNull"),
     *             required={"title"}
     *         )
     *     ),

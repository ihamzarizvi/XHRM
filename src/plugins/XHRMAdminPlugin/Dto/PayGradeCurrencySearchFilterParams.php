...
class PayGradeCurrencySearchFilterParams extends FilterParams
{
    protected ?int $payGradeId = null;

    public const ALLOWED_SORT_FIELDS = ['ct.name'];

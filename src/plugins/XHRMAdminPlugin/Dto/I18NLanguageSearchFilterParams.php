...
class I18NLanguageSearchFilterParams extends FilterParams
{
     ...
     */
    public function setEnabledOnly(?bool $enabledOnly): void
    {
     ...
     * @return bool|null
     */
    public function getAddedOnly(): ?bool
    {
        return $this->addedOnly;
    }

    /**
     * @param bool|null $addedOnly
     */
    public function setAddedOnly(?bool $addedOnly): void
    {

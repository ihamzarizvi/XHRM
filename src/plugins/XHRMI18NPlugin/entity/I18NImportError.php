...
use XHRM\Entity\Decorator\I18NImportErrorDecorator;
...
class I18NImportError
{
     ...
     * @var I18NLangString
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\I18NLangString")
     ...
     * @var I18NLanguage
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\I18NLanguage")
     ...
     * @var I18NError
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\I18NError")

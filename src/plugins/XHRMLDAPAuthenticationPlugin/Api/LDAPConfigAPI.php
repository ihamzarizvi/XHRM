...
use XHRM\LDAP\Api\Model\LDAPConfigModel;
use XHRM\LDAP\Api\Traits\LDAPCommonParamRuleCollection;
...
class LDAPConfigAPI extends Endpoint implements ResourceEndpoint
{
     ...
     *                 property="hostname",
     *                 type="string",
     *                 maxLength=XHRM\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_HOST_NAME_MAX_LENGTH
     *             ),
     ...
     *                 type="string",
     *                 enum={
     *                     XHRM\LDAP\Api\LDAPConfigAPI::ENCRYPTION_NONE,
     *                     XHRM\LDAP\Api\LDAPConfigAPI::ENCRYPTION_TLS,
     *                     XHRM\LDAP\Api\LDAPConfigAPI::ENCRYPTION_SSL
     *                 }
     *             ),
     *             @OA\Property(
     ...
     *                 type="string",
     *                 enum={
     *                     XHRM\LDAP\Api\LDAPConfigAPI::LDAP_IMPLEMENTATION_OPEN_LDAP,
     *                     XHRM\LDAP\Api\LDAPConfigAPI::LDAP_IMPLEMENTATION_ACTIVE_DIRECTORY,
     *                 }
     *             ),
     ...
     *                 property="bindUserDN",
     *                 type="string",
     *                 maxLength=XHRM\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_BIND_USER_DISTINGUISHED_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="bindUserPassword",
     *                 type="string",
     *                 maxLength=XHRM\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_BIND_USER_PASSWORD_MAX_LENGTH
     *             ),
     ...
     *                         property="baseDN",
     *                         type="string",
     *                         maxLength=XHRM\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_BASE_DISTINGUISHED_NAME_MAX_LENGTH
     *                     ),
     *                     @OA\Property(property="searchScope", type="string", enum={"one", "sub"}),
     *                     @OA\Property(
     *                         property="userNameAttribute",
     *                         type="string",
     *                         maxLength=XHRM\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_ATTRIBUTE_MAX_LENGTH
     *                     ),
     *                     @OA\Property(
     *                         property="userSearchFilter",
     *                         type="string",
     *                         maxLength=XHRM\LDAP\Api\LDAPConfigAPI::PARAMETER_RULE_USER_SEARCH_FILTER_MAX_LENGTH
     *                     ),
     *                     @OA\Property(
     ...
     *                                 property="field",
     *                                 type="string",
     *                                 enum={XHRM\LDAP\Dto\LDAPEmployeeSelectorMapping::ALLOWED_FIELDS}
     *                             ),
     *                             @OA\Property(

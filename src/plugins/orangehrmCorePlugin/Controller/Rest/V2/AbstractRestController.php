...
use XHRM\Framework\Http\Request as HttpRequest;
use XHRM\Framework\Http\Response as HttpResponse;
...
abstract class AbstractRestController extends AbstractController
{
    ...
    public function handle(HttpRequest $httpRequest): HttpResponse
    {
        ...
        try {
            ...
            // \XHRM\Core\Subscriber\ApiAuthorizationSubscriber::onExceptionEvent
            throw $e;
        } catch (Exception $e) {

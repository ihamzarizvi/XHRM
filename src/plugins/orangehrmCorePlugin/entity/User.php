...
use XHRM\Entity\Decorator\UserDecorator;
...
class User
{
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="users")
     ...
     * @var UserRole
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\UserRole")
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\UserAuthProvider", mappedBy="user")
     */

...
use XHRM\Entity\Decorator\LeaveEntitlementDecorator;
...
class LeaveEntitlement
{
     ...
     * @var LeaveType
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\LeaveType", inversedBy="leaveEntitlement")
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\LeaveEntitlementType")
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\LeaveLeaveEntitlement", mappedBy="entitlement")
     */

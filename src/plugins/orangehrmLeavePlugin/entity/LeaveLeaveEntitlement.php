...
use XHRM\Entity\Decorator\LeaveLeaveEntitlementDecorator;
...
class LeaveLeaveEntitlement
{
     ...
     * @var Leave
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Leave", inversedBy="leaveLeaveEntitlements")
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\LeaveEntitlement", inversedBy="leaveLeaveEntitlements")

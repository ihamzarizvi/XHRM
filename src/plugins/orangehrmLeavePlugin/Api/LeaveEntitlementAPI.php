...
use XHRM\Leave\Api\Model\LeaveEntitlementModel;
use XHRM\Leave\Api\Model\LeaveEntitlementSummaryModel;
use XHRM\Leave\Api\Traits\LeaveEntitlementPermissionTrait;
use XHRM\Leave\Api\ValidationRules\LeaveTypeIdRule;
use XHRM\Leave\Dto\LeaveEntitlementSearchFilterParams;
...
class LeaveEntitlementAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={\XHRM\Leave\Api\LeaveEntitlementAPI::MODEL_DEFAULT, \XHRM\Leave\Api\LeaveEntitlementAPI::MODEL_SUMMARY},
     *             default=\XHRM\Leave\Api\LeaveEntitlementAPI::MODEL_DEFAULT
     *         )
     *     ),
     *     @OA\Response(
     *         response="200",

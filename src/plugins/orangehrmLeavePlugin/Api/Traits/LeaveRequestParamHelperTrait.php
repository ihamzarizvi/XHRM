...
use XHRM\Leave\Dto\LeaveParameterObject;
            ...
            new Rule(Rules::CALLBACK, [
                function ($duration) {
                    ...
                    if ($durationType === LeaveDuration::SPECIFY_TIME) {
                        ...
                        if (
                            new DateTime($duration[LeaveCommonParams::PARAMETER_DURATION_FROM_TIME]) >=
        ...
        $endDurationRule = new ParamRule(
            ...
            new Rule(Rules::CALLBACK, [
                function ($endDuration) {
                    ...
                    if ($durationType === LeaveDuration::SPECIFY_TIME) {
                        if (
                            (!isset($endDuration[LeaveCommonParams::PARAMETER_DURATION_FROM_TIME]) ||
                                !isset($endDuration[LeaveCommonParams::PARAMETER_DURATION_TO_TIME]))
                        ) {
                            return false;
                        }
                        if (
                            new DateTime($endDuration[LeaveCommonParams::PARAMETER_DURATION_FROM_TIME]) >=

...
use XHRM\Leave\Api\Model\LeaveRequestDetailedModel;
...
use XHRM\Leave\Api\ValidationRules\LeaveTypeIdRule;
use XHRM\Leave\Dto\LeaveRequest\DetailedLeaveRequest;
use XHRM\Leave\Dto\LeaveRequestSearchFilterParams;
use XHRM\Leave\Exception\LeaveAllocationServiceException;
use XHRM\Leave\Service\LeaveAssignmentService;
...
class EmployeeLeaveRequestAPI extends Endpoint implements CrudEndpoint
{
     ...
     *             type="string",
     *             enum={
     *                 XHRM\Leave\Api\EmployeeLeaveRequestAPI::MODEL_DEFAULT,
     *                 XHRM\Leave\Api\EmployeeLeaveRequestAPI::MODEL_DETAILED
     *             },
     *             default=XHRM\Leave\Api\EmployeeLeaveRequestAPI::MODEL_DEFAULT
     *         )
     *     ),
     *     @OA\Response(
     *         response="200",

...
use Exception;
use XHRM\Core\Exception\ConfigurationException;
...
use XHRM\Leave\WorkSchedule\BasicWorkSchedule;
use XHRM\Leave\WorkSchedule\WorkScheduleInterface;
...
class WorkScheduleService
{
    ...
    public function getWorkSchedule(int $empNumber): WorkScheduleInterface
    {
        ...
        if (is_null($this->workScheduleImplementationClass)) {
            ...
            $fallbackNamespace = 'XHRM\\Leave\\WorkSchedule\\';
            if (
                !$this->getClassHelper()->classExists(

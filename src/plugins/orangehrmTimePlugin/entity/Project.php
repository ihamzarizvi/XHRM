...
use XHRM\Entity\Decorator\ProjectDecorator;
...
class Project
{
     ...
     * @var Customer
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Customer", inversedBy="projects", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="XHRM\Entity\Employee", cascade={"persist", "remove"})
     * @ORM\JoinTable(

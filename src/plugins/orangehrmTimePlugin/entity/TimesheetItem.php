...
use XHRM\Entity\Decorator\TimesheetItemDecorator;
...
class TimesheetItem
{
     ...
     * @var Timesheet
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Timesheet")
     ...
     * @var ProjectActivity
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\ProjectActivity", inversedBy="timesheetItems")

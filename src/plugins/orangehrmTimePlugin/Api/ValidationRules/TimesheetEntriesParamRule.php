...
use XHRM\Core\Api\V2\Validator\Rules\ApiDate;
use XHRM\Entity\Timesheet;
use XHRM\Time\Api\EmployeeTimesheetItemAPI;
...
class TimesheetEntriesParamRule extends AbstractRule
{
    ...
    public function validate($entries): bool
    {
        ...
        foreach ($entries as $entry) {
            ...
            if (
                !(isset($entry[EmployeeTimesheetItemAPI::PARAMETER_PROJECT_ID]) &&
            ...
            foreach ($dates as $date => $dateValue) {
                ...
                if (
                    $this->timesheet instanceof Timesheet &&

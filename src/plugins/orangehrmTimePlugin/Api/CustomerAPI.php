...
use XHRM\Time\Api\Model\CustomerModel;
use XHRM\Time\Dto\CustomerSearchFilterParams;
use XHRM\Time\Exception\CustomerServiceException;
...
class CustomerAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="name",
     *                 type="string",
     *                 maxLength=XHRM\Time\Api\CustomerAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="description",
     *                 type="string",
     *                 maxLength=XHRM\Time\Api\CustomerAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH
     *             ),
     *             required={"name"}
     *         )
     *     ),

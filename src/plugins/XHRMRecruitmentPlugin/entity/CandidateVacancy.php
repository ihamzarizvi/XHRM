...
use DateTime;
use XHRM\Entity\Decorator\CandidateVacancyDecorator;
...
class CandidateVacancy
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Candidate", inversedBy="candidateVacancy", cascade={"persist", "remove"})

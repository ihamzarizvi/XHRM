...
use XHRM\Entity\Decorator\CandidateHistoryDecorator;
...
class CandidateHistory
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Candidate", cascade={"persist", "remove"})
    ...
    /**
     * @var Vacancy|null
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Vacancy", cascade={"persist", "remove"})
     ...
     * @var Interview|null
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\Interview", cascade={"persist", "remove"})
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="candidates", cascade={"persist", "remove"})

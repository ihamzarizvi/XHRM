...
use XHRM\Entity\Decorator\CandidateAttachmentDecorator;
...
class CandidateAttachment
{
    ...
    /**
     * @var Candidate
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Candidate", inversedBy="candidateAttachments", cascade={"persist", "remove"})

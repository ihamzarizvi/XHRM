...
use XHRM\Recruitment\Api\Model\CandidateHistoryDetailedModel;
use XHRM\Recruitment\Api\Model\CandidateHistoryListModel;
use XHRM\Recruitment\Dto\CandidateActionHistory;
use XHRM\Recruitment\Dto\CandidateHistorySearchFilterParams;
...
class CandidateHistoryAPI extends Endpoint implements CrudEndpoint
{
    ...
    public function getOne(): EndpointResult
    {
        ...
        if ($vacancy->getHiringManager()->getEmpNumber() !== null) {
            if (
                $candidateHistoryRecord->getAction() === WorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_SHORTLIST &&
                (
                    !is_null($vacancy) &&

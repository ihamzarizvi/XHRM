...
use XHRM\Recruitment\Api\Model\CandidateInterviewModel;
...
class CandidateInterviewSchedulingAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 type="string",
     *                 maxLength=XHRM\Recruitment\Api\CandidateInterviewSchedulingAPI::PARAMETER_RULE_INTERVIEW_NAME_MAX_LENGTH
     *             ),
     ...
     *                 property="note",
     *                 type="string",
     *                 maxLength=XHRM\Recruitment\Api\CandidateInterviewSchedulingAPI::PARAMETER_RULE_NOTE_MAX_LENGTH
     *             ),

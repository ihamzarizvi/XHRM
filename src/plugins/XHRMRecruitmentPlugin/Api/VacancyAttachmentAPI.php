...
use XHRM\Recruitment\Api\Model\VacancyAttachmentModel;
...
class VacancyAttachmentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="comment",
     *                 type="string",
     *                 maxLength=XHRM\Recruitment\Api\VacancyAttachmentAPI::PARAM_RULE_COMMENT_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="attachmentType",
     *                 type="integer",
     *                 maximum=XHRM\Recruitment\Api\VacancyAttachmentAPI::PARAM_RULE_ATTACHMENT_TYPE_MAX_LENGTH
     *             ),

...
use XHRM\Core\Api\V2\Serializer\NormalizeException;
...
use XHRM\Time\Api\Model\TimesheetModel;
use XHRM\Time\Api\Traits\TimesheetPermissionTrait;
use XHRM\Time\Api\ValidationRules\MyTimesheetActionRule;
use XHRM\Time\Api\ValidationRules\TimesheetDateRule;
use XHRM\Time\Dto\TimesheetSearchFilterParams;
use XHRM\Time\Service\TimesheetService;
...
class EmployeeTimesheetAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="action",
     *                 type="string",
     *                 enum=XHRM\Time\Service\TimesheetService::TIMESHEET_ACTION_MAP
     *             ),
     *             @OA\Property(
     *                 property="comment",
     *                 type="string",
     *                 maxLength=XHRM\Time\Api\EmployeeTimesheetAPI::PARAM_RULE_COMMENT_MAX_LENGTH
     *             ),
     *             required={"date"}
     *         )
     *     ),

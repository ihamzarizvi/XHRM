...
use XHRM\Time\Api\Model\ProjectDetailedModel;
use XHRM\Time\Api\Model\ProjectModel;
use XHRM\Time\Dto\ProjectSearchFilterParams;
...
class ProjectAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             maxLength=XHRM\Time\Api\ProjectAPI::PARAMETER_RULE_NAME_MAX_LENGTH
     *         )
     *     ),
     *     @OA\Parameter(
     *         name="empNumber",
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={XHRM\Time\Api\ProjectAPI::MODEL_DEFAULT, XHRM\Time\Api\ProjectAPI::MODEL_DETAILED},
     *             default=XHRM\Time\Api\ProjectAPI::MODEL_DEFAULT
     *         )
     *     ),
     ...
     *                 type="string",
     *                 maxLength=XHRM\Time\Api\ProjectAPI::PARAMETER_RULE_DESCRIPTION_MAX_LENGTH
     *             ),

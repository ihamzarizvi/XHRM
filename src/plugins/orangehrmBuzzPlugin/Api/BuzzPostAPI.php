...
use XHRM\Buzz\Api\Model\BuzzPostModel;
use XHRM\Buzz\Api\ValidationRules\BuzzVideoLinkValidationRule;
use XHRM\Buzz\Dto\BuzzFeedFilterParams;
use XHRM\Buzz\Dto\BuzzFeedPost;
...
use XHRM\Entity\BuzzLink;
use XHRM\Entity\BuzzPhoto;
use XHRM\Entity\BuzzPost;
...
class BuzzPostAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={XHRM\Buzz\Api\BuzzPostAPI::MODEL_DEFAULT_POST, XHRM\Buzz\Api\BuzzPostAPI::MODEL_DETAILED_POST},
     *             default=XHRM\Buzz\Api\BuzzPostAPI::MODEL_DEFAULT_POST
     *         )
     *     ),
     *     @OA\Response(response="200",
     *         description="Success",
    ...
    public function update(): EndpointResult
    {
        ...
        try {
            ...
            if ($originalPostType === BuzzShare::POST_TYPE_VIDEO) {
                ...
                $originalPostType === BuzzShare::POST_TYPE_TEXT

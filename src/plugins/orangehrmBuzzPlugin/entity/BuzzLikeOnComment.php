...
use XHRM\Entity\Decorator\BuzzLikeOnCommentDecorator;
use XHRM\Core\Traits\Service\DateTimeHelperTrait;
use XHRM\Entity\Decorator\DecoratorTrait;

/**
 * @method BuzzLikeOnCommentDecorator getDecorator()
 *
...
class BuzzLikeOnComment
{
     ...
     * @var BuzzComment
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\BuzzComment")
     ...
     * @return BuzzComment
     */
    public function getComment(): BuzzComment
    {
        return $this->comment;
    }
     ...
     */
    public function setComment(BuzzComment $comment): void
    {

...
use XHRM\Entity\Decorator\BuzzPostDecorator;
...
class BuzzPost
{
     ...
     * @var BuzzPhoto[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\BuzzPhoto", mappedBy="post")
     */
     ...
     * @var BuzzLink[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\BuzzLink", mappedBy="post")
     */

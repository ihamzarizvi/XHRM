...
use XHRM\Core\Dao\ReportGeneratorDao;
use XHRM\Core\Dto\FilterParams;
use XHRM\Core\Report\DisplayField\BasicDisplayField;
use XHRM\Core\Report\DisplayField\CombinedDisplayField;
use XHRM\Core\Report\DisplayField\EntityAliasMapping;
use XHRM\Core\Report\DisplayField\GenericBasicDisplayField;
use XHRM\Core\Report\DisplayField\GenericDateDisplayField;
...
use XHRM\Core\Report\FilterField\FilterField;
use XHRM\Core\Report\FilterField\ValueXModifiable;
use XHRM\Core\Report\FilterField\ValueYModifiable;
use XHRM\Core\Report\Header\Column;
use XHRM\Core\Report\Header\Header;
use XHRM\Core\Report\Header\HeaderData;
use XHRM\Core\Report\Header\StackedColumn;
use XHRM\Core\Report\ReportSearchFilterParams;
use XHRM\Core\Traits\ORM\EntityManagerHelperTrait;
use XHRM\Entity\AbstractDisplayField;
use XHRM\Entity\CompositeDisplayField;
use XHRM\Entity\DisplayField;
use XHRM\Entity\Employee;
use XHRM\Entity\Report;
use XHRM\Entity\SelectedFilterField;
use XHRM\Entity\SummaryDisplayField;
...
class ReportGeneratorService
{
    ...
    protected function getReportDataQueryBuilder(ReportSearchFilterParams $filterParams): array
    {
        ...
        foreach ($displayFields as $displayField) {
            ...
            if ($displayFieldClass instanceof \XHRM\Core\Report\DisplayField\DisplayField) {
                if (
                    $displayFieldClass instanceof GenericBasicDisplayField ||

...
{
    /**
     * @see \XHRM\Pim\Event\EmployeeJoinedDateChangedEvent
     */
    public const JOINED_DATE_CHANGED = 'pim.employee_join_date_changed';

    /**
     * @see \XHRM\Pim\Event\EmployeeAddedEvent
     */
    public const EMPLOYEE_ADDED = 'pim.employee_added';

    /**
     * @see \XHRM\Pim\Event\EmployeeSavedEvent
     */
    public const EMPLOYEE_SAVED = 'pim.employee_saved';

    /**
     * @see \XHRM\Pim\Event\EmployeeDeletedEvent
     */

...
class EmployeeService
{
    ...
    public function getUndeletableEmpNumbers(): array
    {
        ...
        if (
            Config::PRODUCT_MODE === Config::MODE_DEMO &&

...
use XHRM\Entity\Decorator\EmployeeMembershipDecorator;
...
class EmployeeMembership
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="memberships", cascade={"persist"})
     ...
     * @var Membership
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Membership")

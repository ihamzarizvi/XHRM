...
use XHRM\Entity\Decorator\ReportToDecorator;
...
class ReportTo
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", cascade={"persist"})
     ...
     * @var ReportingMethod
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\ReportingMethod", inversedBy="reportTos", cascade={"persist"})

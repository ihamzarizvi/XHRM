...
use XHRM\Entity\Decorator\EmployeeSalaryDecorator;
 ...
 * @ORM\Entity
 * @ORM\EntityListeners({"XHRM\Entity\Listener\EmployeeSalaryListener"})
 */
class EmployeeSalary
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="salaries", cascade={"persist"})
     ...
     * @var PayGrade|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\PayGrade")
     ...
     * @var CurrencyType
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\CurrencyType")
     ...
     * @var PayPeriod|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\PayPeriod")
     ...
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\EmpDirectDebit", mappedBy="salary", cascade={"persist"})
     */

...
use XHRM\Entity\Decorator\EmployeeTerminationRecordDecorator;
...
class EmployeeTerminationRecord
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\TerminationReason")
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="employeeTerminationRecords")

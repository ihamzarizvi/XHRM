...
use XHRM\Pim\Api\Model\EmployeeSkillModel;
use XHRM\Pim\Dto\EmployeeSkillSearchFilterParams;
use XHRM\Pim\Service\EmployeeSkillService;
...
class EmployeeSkillAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 type="integer",
     *                 maxLength=XHRM\Pim\Api\EmployeeSkillAPI::PARAM_RULE_YEARS_OF_EXP_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="comments",
     *                 description="Specify the comment regarding the skill",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeSkillAPI::PARAM_RULE_COMMENTS_MAX_LENGTH
     *             ),

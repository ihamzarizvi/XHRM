...
use XHRM\Pim\Api\Model\EmployeeDependentModel;
use XHRM\Pim\Dto\EmployeeDependentSearchFilterParams;
use XHRM\Pim\Service\EmployeeDependentService;
...
class EmployeeDependentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 description="Specify the name of the dependent",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeDependentAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="relationshipType",
     *                 description="Specify the relationship type",
     *                 type="string",
     *                 enum={XHRM\Entity\EmpDependent::RELATIONSHIP_TYPE_CHILD, XHRM\Entity\EmpDependent::RELATIONSHIP_TYPE_OTHER}
     *             ),
     *             @OA\Property(
     *                 property="relationship",
     *                 description="Specify additional details of the relationship",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeDependentAPI::PARAM_RULE_RELATIONSHIP_MAX_LENGTH
     *             ),

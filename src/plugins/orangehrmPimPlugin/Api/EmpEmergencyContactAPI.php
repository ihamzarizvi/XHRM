...
use XHRM\Pim\Api\Model\EmpEmergencyContactModel;
use XHRM\Pim\Dto\EmpEmergencyContactSearchFilterParams;
use XHRM\Pim\Service\EmpEmergencyContactService;
...
class EmpEmergencyContactAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         in="query",
     *         required=false,
     *         @OA\Schema(type="string", maxLength=XHRM\Pim\Api\EmpEmergencyContactAPI::PARAM_RULE_MAX_LENGTH)
     *     ),
     *     @OA\Parameter(
     *         name="sortField",
     ...
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmpEmergencyContactAPI::PARAM_RULE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     ...
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmpEmergencyContactAPI::PARAM_RULE_HOME_PHONE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="officePhone",
     *                 description="Specfiy the office phone number of the emergency contact",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmpEmergencyContactAPI::PARAM_RULE_OFFICE_PHONE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="mobilePhone",
     *                 description="Specify the mobile phone number of the emergency contact",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmpEmergencyContactAPI::PARAM_RULE_MOBILE_PHONE_MAX_LENGTH
     *             ),

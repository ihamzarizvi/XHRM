...
use XHRM\Pim\Api\Model\PimDefinedReportDetailedModel;
use XHRM\Pim\Api\Model\PimDefinedReportModel;
...
class PimDefinedReportAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="name",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\PimDefinedReportAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),

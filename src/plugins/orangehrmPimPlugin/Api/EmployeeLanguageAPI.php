...
use XHRM\Pim\Api\Model\EmployeeLanguageModel;
use XHRM\Pim\Dto\EmployeeLanguagesSearchFilterParams;
...
class EmployeeLanguageAPI extends Endpoint implements CrudEndpoint
{
     ...
     *             @OA\Property(property="fluencyId", description="Specify the numerical ID of the fluency", type="integer", enum=XHRM\Entity\EmployeeLanguage::FLUENCIES),
     *             @OA\Property(property="competencyId", description="Specify the numerical ID of the compenetency", type="integer", enum=XHRM\Entity\EmployeeLanguage::COMPETENCIES),
     ...
     *             @OA\Property(property="languageId", description="Specify the numerical ID of the language", type="integer"),
     *             @OA\Property(property="fluencyId", description="Specify the numerical ID of the fluency", type="integer", enum=XHRM\Entity\EmployeeLanguage::FLUENCIES),
     *             @OA\Property(property="competencyId", description="Specify the numerical ID of the competency", type="integer", enum=XHRM\Entity\EmployeeLanguage::COMPETENCIES),

...
use XHRM\Pim\Api\Model\EmployeeContactDetailsModel;
...
class EmployeeContactDetailsAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_STREET_1_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="street2",
     *                 description="Specify additional details of the street address",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_STREET_2_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="city",
     *                 description="Specify the employee's city",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_CITY_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="province",
     *                 description="Specify the employee's state/province",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_PROVINCE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="zipCode",
     *                 description="Specify the employee's zipcode",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_ZIP_CODE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="countryCode",
     *                 description="Specify the employee's country code",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_COUNTRY_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="homeTelephone",
     *                 description="Specify the employee's home telephone number",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_HOME_TELEPHONE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="workTelephone",
     *                 description="Specify the employee's work telephone number",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_WORK_TELEPHONE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="mobile",
     *                 description="Specify the employee's mobile phone number",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_MOBILE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="workEmail",
     *                 description="Specify the employee's work email",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_WORK_EMAIL_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="otherEmail",
     *                 description="Specify the employee's other email",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeContactDetailsAPI::PARAM_RULE_OTHER_EMAIL_MAX_LENGTH
     *             ),
     *         )
     *     ),
     *     @OA\Response(response="200",

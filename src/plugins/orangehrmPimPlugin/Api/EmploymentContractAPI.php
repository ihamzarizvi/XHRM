...
use XHRM\Pim\Api\Model\EmploymentContractModel;
...
class EmploymentContractAPI extends Endpoint implements ResourceEndpoint
{
     ...
     *                 type="string",
     *                 enum={
     *                     XHRM\Pim\Api\EmploymentContractAPI::CONTRACT_ATTACHMENT_REPLACE_CURRENT,
     *                     XHRM\Pim\Api\EmploymentContractAPI::CONTRACT_ATTACHMENT_KEEP_CURRENT,
     *                     XHRM\Pim\Api\EmploymentContractAPI::CONTRACT_ATTACHMENT_DELETE_CURRENT
     *                 }
     *             ),

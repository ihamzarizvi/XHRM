...
use XHRM\Pim\Api\Model\EmployeePersonalDetailModel;
...
class EmployeePersonalDetailAPI extends Endpoint implements ResourceEndpoint
{
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="lastName", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_LAST_NAME_MAX_LENGTH),
     *             @OA\Property(property="firstName", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_FIRST_NAME_MAX_LENGTH),
     *             @OA\Property(property="middleName", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_MIDDLE_NAME_MAX_LENGTH),
     *             @OA\Property(property="employeeId", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_EMPLOYEE_ID_MAX_LENGTH),
     *             @OA\Property(property="otherId", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_OTHER_ID_MAX_LENGTH),
     *             @OA\Property(property="drivingLicenseNo", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_DRIVING_LICENSE_NO_MAX_LENGTH),
     *             @OA\Property(property="drivingLicenseExpiredDate", type="string", format="date"),
     *             @OA\Property(property="ssnNumber", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_SSN_NUMBER_MAX_LENGTH),
     *             @OA\Property(property="sinNumber", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_SIN_NUMBER_MAX_LENGTH),
     *             @OA\Property(property="gender", type="integer"),
     *             @OA\Property(property="maritalStatus", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_MARTIAL_STATUS_MAX_LENGTH),
     *             @OA\Property(property="birthday", type="string", format="date"),
     *             @OA\Property(property="nationalityId", type="integer"),
     *             @OA\Property(property="nickname", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_NICKNAME_MAX_LENGTH),
     *             @OA\Property(property="smoker", type="boolean"),
     *             @OA\Property(property="militaryService", type="string", maxLength=XHRM\Pim\Api\EmployeePersonalDetailAPI::PARAM_RULE_MILITARY_SERVICE_MAX_LENGTH),

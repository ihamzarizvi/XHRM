...
use XHRM\Pim\Api\Model\EmployeeAttachmentModel;
...
class EmployeeAttachmentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(type="string", enum=XHRM\Entity\EmployeeAttachment::SCREENS)
     *     ),
     *     @OA\PathParameter(
     *         name="id",
     ...
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeAttachmentAPI::PARAM_RULE_DESCRIPTION_MAX_LENGTH
     *             ),
     ...
     *                 type="object",
     *                 @OA\Property(property="empNumber", description="The employee number given in the request", type="integer"),
     *                 @OA\Property(property="screen", description="The PIM screen name given in the request", type="string", enum=XHRM\Entity\EmployeeAttachment::SCREENS)
     *             )
     *         )
     *     ),
     * )

...
use XHRM\Pim\Api\Model\ReportingMethodConfigurationModel;
use XHRM\Pim\Dto\ReportingMethodSearchFilterParams;
use XHRM\Pim\Service\ReportingMethodConfigurationService;
...
class ReportingMethodConfigurationAPI extends EndPoint implements CrudEndpoint
{
     ...
     *                 property="name",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\ReportingMethodConfigurationAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             required={"name"}
     *         )
     *     ),

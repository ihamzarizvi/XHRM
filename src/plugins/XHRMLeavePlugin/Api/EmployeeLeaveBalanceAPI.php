...
use XHRM\Leave\Dto\EmployeeLeaveBalanceSearchFilterParams;
use XHRM\Leave\Dto\LeaveTypeSearchFilterParams;
...
class EmployeeLeaveBalanceAPI extends Endpoint implements CollectionEndpoint
{
    ...
    {
        if (
            $this->getRequestParams()->has(RequestParams::PARAM_TYPE_QUERY, LeaveCommonParams::PARAMETER_FROM_DATE) xor
        ...
        if (
            !$this->getRequestParams()->has(RequestParams::PARAM_TYPE_QUERY, LeaveCommonParams::PARAMETER_FROM_DATE) ||
            !$this->getRequestParams()->has(RequestParams::PARAM_TYPE_QUERY, LeaveCommonParams::PARAMETER_TO_DATE)
        ) {

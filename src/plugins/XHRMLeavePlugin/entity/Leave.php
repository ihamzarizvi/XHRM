...
use XHRM\Entity\Decorator\LeaveDecorator;
...
class Leave
{
     ...
     * @var LeaveRequest
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\LeaveRequest", inversedBy="leaves")
     ...
     * @var LeaveType
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\LeaveType")
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\LeaveLeaveEntitlement", mappedBy="leave")
     */

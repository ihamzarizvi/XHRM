...
use XHRM\Admin\Dto\EmailSubscriberSearchFilterParams;
use XHRM\Admin\Service\EmailSubscriberService;
use XHRM\Core\Traits\Service\DateTimeHelperTrait;
use XHRM\Core\Traits\UserRoleManagerTrait;
use XHRM\Entity\EmailNotification;
use XHRM\Entity\EmailSubscriber;
...
abstract class AbstractLeaveEmailProcessor
{
    ...
    protected function getLeaveDetailsByDetailedLeaves(array $detailedLeaves): array
    {
        ...
        foreach ($detailedLeaves as $detailedLeave) {
            ...
            if (
                $dates->getDurationType() === LeaveDuration::HALF_DAY_MORNING ||

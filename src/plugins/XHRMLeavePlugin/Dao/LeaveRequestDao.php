...
use XHRM\Entity\LeaveStatus;
use XHRM\Leave\Dto\CurrentAndChangeEntitlement;
use XHRM\Leave\Dto\EmployeeLeaveSearchFilterParams;
...
class LeaveRequestDao extends BaseDao
{
    ...
    private function getLeaveRequestsPaginator(
        ...
        if (
            is_null($leaveRequestSearchFilterParams->getIncludeEmployees()) ||
    ...
    public function getEmployeeLeavesPaginator(EmployeeLeaveSearchFilterParams $leaveSearchFilterParams): Paginator
    {
        ...
        if (
            $leaveSearchFilterParams->getIncludeEmployees() === null ||

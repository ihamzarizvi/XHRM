...
use XHRM\Leave\Dao\LeaveEntitlementDao;
use XHRM\Leave\Entitlement\EntitlementConsumptionStrategy;
use XHRM\Leave\Entitlement\FIFOEntitlementConsumptionStrategy;
...
class LeaveEntitlementService
{
    ...
    public function getLeaveEntitlementStrategy(): EntitlementConsumptionStrategy
    {
        if (!$this->leaveEntitlementStrategy instanceof EntitlementConsumptionStrategy) {
            ...
            $strategyClass = $this->getClassHelper()->getClass($strategyClass, 'XHRM\\Leave\\Entitlement\\');

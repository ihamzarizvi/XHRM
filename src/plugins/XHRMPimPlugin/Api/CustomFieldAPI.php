...
use XHRM\Pim\Api\Model\CustomFieldModel;
use XHRM\Pim\Dto\CustomFieldSearchFilterParams;
...
class CustomFieldAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\CustomFieldAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="fieldType",
     *                 description="Specify whether the field is a text/number field or a dropdown field",
     *                 type="integer",
     *                 enum=XHRM\Entity\CustomField::FIELD_TYPES,
     *                 maxLength=XHRM\Pim\Api\CustomFieldAPI::PARAM_RULE_TYPE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="screen",
     *                 description="Specify which PIM screen this field should be displayed",
     *                 type="string",
     *                 enum=XHRM\Entity\CustomField::SCREENS,
     *                 maxLength=XHRM\Pim\Api\CustomFieldAPI::PARAM_RULE_SCREEN_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="extraData",
     *                 description="Specify a comma separated list of options for the dropdown type custom fields",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\CustomFieldAPI::PARAM_RULE_EXTRA_DATA_MAX_LENGTH
     *             ),
     *         ),
     *     ),
    ...
    public function update(): EndpointResourceResult
    {
        ...
        if (
            $type == $customField->getType() || !$this->getCustomFieldService()->getCustomFieldDao(

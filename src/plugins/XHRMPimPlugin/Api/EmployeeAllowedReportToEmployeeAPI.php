...
use XHRM\Pim\Api\Model\EmployeeAllowedReportToEmployeeModel;
use XHRM\Pim\Dto\EmployeeSearchFilterParams;
use XHRM\Pim\Service\EmployeeReportingMethodService;
...
class EmployeeAllowedReportToEmployeeAPI extends Endpoint implements CollectionEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             maxLength=XHRM\Pim\Api\EmployeeAllowedReportToEmployeeAPI::PARAM_RULE_FILTER_NAME_OR_ID_MAX_LENGTH
     *         )
     *     ),
     *     @OA\Parameter(
     *         name="sortField",

...
use XHRM\Entity\EmpDirectDebit;
use XHRM\Entity\EmployeeSalary;
use XHRM\Framework\Services;
use XHRM\Pim\Api\Model\EmployeeSalaryModel;
...
class EmployeeSalaryComponentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_SALARY_COMPONENT_MAX_LENGTH
     *             ),
     ...
     *                 type="string",
     *                 minimum=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_SALARY_AMOUNT_MIN,
     *                 maximum=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_SALARY_AMOUNT_MAX,
     *             ),
     *             @OA\Property(
     *                 property="comment",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_COMMENT_MAX_LENGTH,
     *                 nullable=true
     *             ),
     ...
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_DIRECT_DEPOSIT_ACCOUNT_MAX_LENGTH,
     *                 nullable=true
     *             ),
     *             @OA\Property(
     *                 property="directDepositAccountType",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_DIRECT_DEPOSIT_ACCOUNT_TYPE_MAX_LENGTH,
     *                 nullable=true
     *             ),
     *             @OA\Property(
     *                 property="directDepositRoutingNumber",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_DIRECT_DEPOSIT_ROUTING_NUMBER_MAX_LENGTH,
     *                 nullable=true
     *             ),
     *             @OA\Property(
     *                 property="directDepositAmount",
     *                 type="number",
     *                 minimum=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_DIRECT_DEPOSIT_AMOUNT_MIN,
     *                 maximum=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_DIRECT_DEPOSIT_AMOUNT_MAX,
     *                 nullable=true
     *             ),
     ...
     *             type="object",
     *             @OA\Property(property="payGradeId", type="integer", nullable=true),
     *             @OA\Property(property="salaryComponent", type="string", maxLength=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_SALARY_COMPONENT_MAX_LENGTH),
     *             @OA\Property(property="payFrequencyId", type="integer", nullable=true),
     *             @OA\Property(property="currencyId", type="string"),
     *             @OA\Property(
     *                 property="salaryAmount",
     ...
     *                 maximum=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_SALARY_AMOUNT_MAX,
     *             ),
     *             @OA\Property(property="comment", type="string", maxLength=XHRM\Pim\Api\EmployeeSalaryComponentAPI::PARAM_RULE_COMMENT_MAX_LENGTH, nullable=true),
     *             @OA\Property(property="addDirectDeposit", type="boolean"),
     *             required={"salaryComponent", "currencyId", "salaryAmount"}
     *         )
     *     ),

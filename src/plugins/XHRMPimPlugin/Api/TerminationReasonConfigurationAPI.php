...
use XHRM\Pim\Api\Model\TerminationReasonConfigurationModel;
use XHRM\Pim\Dto\TerminationReasonConfigurationSearchFilterParams;
use XHRM\Pim\Service\TerminationReasonConfigurationService;
...
class TerminationReasonConfigurationAPI extends EndPoint implements CrudEndpoint
{
     ...
     *                 property="name",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\TerminationReasonConfigurationAPI::PARAM_RULE_NAME_MAX_LENGTH
     *             ),
     *             required={"name"}
     *         )
     *     ),

...
use XHRM\Entity\EmpWorkExperience;
use XHRM\Pim\Api\Model\EmployeeWorkExperienceModel;
use XHRM\Pim\Dto\EmployeeWorkExperienceSearchFilterParams;
use XHRM\Pim\Service\EmployeeWorkExperienceService;
...
class EmployeeWorkExperienceAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="company",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeWorkExperienceAPI::PARAM_RULE_EMPLOYER_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="jobTitle",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeWorkExperienceAPI::PARAM_RULE_JOB_TITLE_MAX_LENGTH
     *             ),
     ...
     *                 property="comment",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeWorkExperienceAPI::PARAM_RULE_COMMENTS_MAX_LENGTH
     *             ),

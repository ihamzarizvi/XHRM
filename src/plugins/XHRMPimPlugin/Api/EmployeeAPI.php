...
class EmployeeAPI extends Endpoint implements CrudEndpoint
{
     ...
     *         @OA\Schema(
     *             type="string",
     *             enum={XHRM\Pim\Api\EmployeeAPI::MODEL_DEFAULT, XHRM\Pim\Api\EmployeeAPI::MODEL_DETAILED},
     *             default=XHRM\Pim\Api\EmployeeAPI::MODEL_DEFAULT
     *         )
     *     ),
     *     @OA\Response(
     *         response="200",
     ...
     *         in="query",
     *         required=false,
     *         @OA\Schema(type="string", maxLength=XHRM\Pim\Api\EmployeeAPI::PARAM_RULE_FILTER_NAME_MAX_LENGTH)
     *     ),
     *     @OA\Parameter(
     *         name="nameOrId",
     ...
     *         in="query",
     *         required=false,
     *         @OA\Schema(type="string", maxLength=XHRM\Pim\Api\EmployeeAPI::PARAM_RULE_FILTER_NAME_OR_ID_MAX_LENGTH)
     *     ),
     *     @OA\Parameter(
     *         name="employeeId",
     ...
     *         in="query",
     *         required=false,
     *         @OA\Schema(type="integer", maxLength=XHRM\Pim\Api\EmployeeAPI::PARAM_RULE_EMPLOYEE_ID_MAX_LENGTH)
     *     ),
     *     @OA\Parameter(
     *         name="jobTitleId",
     ...
     *         in="query",
     *         required=false,
     *         @OA\Schema(type="integer", enum=XHRM\Pim\Dto\EmployeeSearchFilterParams::INCLUDE_EMPLOYEES_MAP)
     *     ),
     *     @OA\Parameter(
     *         name="model",
     *         description="Specify whether the result should be default or detailed",
     ...
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeAPI::PARAM_RULE_LAST_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="firstName",
     *                 description="Specify the employee's first name",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeAPI::PARAM_RULE_FIRST_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="middleName",
     *                 description="Specify the employee's middle name",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeAPI::PARAM_RULE_MIDDLE_NAME_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="employeeId",
     *                 description="Specify the employeee's ID",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeAPI::PARAM_RULE_EMPLOYEE_ID_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="empPicture",

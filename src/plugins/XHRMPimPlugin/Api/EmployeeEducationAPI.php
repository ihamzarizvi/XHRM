...
use XHRM\Pim\Api\Model\EmployeeEducationModel;
use XHRM\Pim\Dto\EmployeeEducationSearchFilterParams;
use XHRM\Pim\Service\EmployeeEducationService;
...
class EmployeeEducationAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="institute",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeEducationAPI::PARAM_RULE_INSTITUTE_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="major",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeEducationAPI::PARAM_RULE_MAJOR_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="year",
     *                 type="integer",
     *                 maxLength=XHRM\Pim\Api\EmployeeEducationAPI::PARAM_RULE_YEAR_MAX_LENGTH
     *             ),
     *             @OA\Property(
     *                 property="score",
     *                 type="string",
     *                 maxLength=XHRM\Pim\Api\EmployeeEducationAPI::PARAM_RULE_SCORE_MAX_LENGTH
     *             ),

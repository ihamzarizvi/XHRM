...
use XHRM\Entity\Decorator\EmployeeImmigrationRecordDecorator;
...
class EmployeeImmigrationRecord
{
     ...
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="immigrationRecords", cascade={"persist"})

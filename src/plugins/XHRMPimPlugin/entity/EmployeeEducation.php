...
use XHRM\Entity\Decorator\EmployeeEducationDecorator;
...
class EmployeeEducation
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="educations", cascade={"persist"})
     ...
     * @var Education
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Education", inversedBy="employeeEducation")

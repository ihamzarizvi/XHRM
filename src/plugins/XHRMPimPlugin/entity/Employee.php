...
use XHRM\Entity\Decorator\EmployeeDecorator;
 ...
 * @ORM\Entity
 * @ORM\EntityListeners({"XHRM\Entity\Listener\EmployeeListener"})
 */
class Employee
{
    use DecoratorTrait;
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Nationality")
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\EmploymentStatus", inversedBy="employees")
     ...
     * @var JobTitle|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\JobTitle", inversedBy="employees")
     ...
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\JobCategory")
     ...
     * @var Subunit|null
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Subunit")
     ...
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\EmployeeTerminationRecord", cascade={"persist"})
     ...
     * @var Location[]
     *
     * @ORM\ManyToMany(targetEntity="XHRM\Entity\Location", inversedBy="employees")
     * @ORM\JoinTable(
     ...
     * @var EmpDependent[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmpDependent", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmpEmergencyContact", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeImmigrationRecord", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmpWorkExperience", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeEducation", mappedBy="employee")
     */
     ...
     * @var EmployeeSkill[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeSkill", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeLanguage", mappedBy="employee")
     */
     ...
     * @var EmployeeLicense[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeLicense", mappedBy="employee")
     */
     ...
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeMembership", mappedBy="employee")
     */
     ...
     * @var EmployeeSalary[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeSalary", mappedBy="employee")
     */
     ...
     * @var EmpContract[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmpContract", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeAttachment", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\EmployeeTerminationRecord", mappedBy="employee")
     */
     ...
     * @var User[]
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\User", mappedBy="employee")
     */
     ...
     * @var EmpPicture|null
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\EmpPicture", mappedBy="employee")
     */
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="XHRM\Entity\Employee", mappedBy="supervisors")
     */
     ...
     * @var Employee[]
     *
     * @ORM\ManyToMany(targetEntity="XHRM\Entity\Employee", inversedBy="subordinates")
     * @ORM\JoinTable(
     ...
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\EmpUsTaxExemption", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToOne(targetEntity="XHRM\Entity\EmployeeWorkShift", mappedBy="employee")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="XHRM\Entity\AttendanceRecord", mappedBy="employee")
     */

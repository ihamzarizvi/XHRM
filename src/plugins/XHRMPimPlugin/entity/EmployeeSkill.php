...
use XHRM\Entity\Decorator\EmployeeSkillDecorator;
...
class EmployeeSkill
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="skills", cascade={"persist"})
     * @ORM\Id
     ...
     * @var Skill
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Skill", inversedBy="employeeSkills")
     * @ORM\Id

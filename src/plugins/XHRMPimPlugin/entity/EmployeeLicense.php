...
use XHRM\Entity\Decorator\EmployeeLicenseDecorator;
...
class EmployeeLicense
{
     ...
     * @var License
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\License", inversedBy="employeeLicenses")
     * @ORM\Id
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="licenses", cascade={"persist"})
     * @ORM\Id

...
class CorporateBrandingPluginConfiguration implements PluginConfigurationInterface
{
    ...
    {
        $this->getContainer()->register(Services::THEME_SERVICE, ThemeService::class);
    }
}

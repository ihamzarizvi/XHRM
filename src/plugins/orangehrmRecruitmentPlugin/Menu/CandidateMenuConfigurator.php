...
namespace XHRM\Recruitment\Menu;
...
class CandidateMenuConfigurator implements MenuConfigurator
{
    ...
    {
        $this->getCurrentModuleAndScreen()->overrideScreen('viewCandidates');
        return null;
    }
}

...
use XHRM\Entity\Decorator\CandidateDecorator;
...
class Candidate
{
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="candidates", cascade={"persist"})
     ...
     * @ORM\OneToMany(targetEntity="XHRM\Entity\CandidateVacancy", mappedBy="candidate")
     */
    private iterable $candidateVacancy;

    /**
     * @var iterable|CandidateAttachment[]
     * @ORM\OneToMany(targetEntity="XHRM\Entity\CandidateAttachment", mappedBy="candidate")
     */
    private iterable $candidateAttachment;

    /**
     * @var iterable|CandidateHistory[]
     * @ORM\OneToMany(targetEntity="XHRM\Entity\CandidateHistory", mappedBy="candidate")
     */

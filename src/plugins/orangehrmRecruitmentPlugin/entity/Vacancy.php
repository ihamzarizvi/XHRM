...
use XHRM\Entity\Decorator\VacancyDecorator;
...
class Vacancy
{
    ...
    /**
     * @var JobTitle
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\JobTitle", inversedBy="vacancies", cascade={"persist", "remove"})
    ...
    /**
     * @var Employee|null
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="vacancies", cascade={"persist", "remove"})

...
use XHRM\Entity\Decorator\InterviewDecorator;
...
class Interview
{
     ...
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\CandidateVacancy", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="XHRM\Entity\Employee")

...
use XHRM\Recruitment\Api\Model\CandidateDetailedModel;
use XHRM\Recruitment\Api\Model\CandidateListModel;
use XHRM\Recruitment\Api\Model\CandidateModel;
...
class CandidateAPI extends Endpoint implements CrudEndpoint
{
     ...
     *             type="string",
     *             enum={
     *                 XHRM\Recruitment\Api\CandidateAPI::MODEL_DEFAULT,
     *                 XHRM\Recruitment\Api\CandidateAPI::MODEL_CANDIDATE_LIST,
     *                 XHRM\Recruitment\Api\CandidateAPI::MODEL_CANDIDATE_DETAILED
     *             }
     *         )
     *     ),
     ...
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(property="firstName", type="string", maxLength=XHRM\Recruitment\Api\CandidateAPI::PARAMETER_RULE_NAME_MAX_LENGTH),
     *             @OA\Property(property="middleName", type="string", maxLength=XHRM\Recruitment\Api\CandidateAPI::PARAMETER_RULE_NAME_MAX_LENGTH),
     *             @OA\Property(property="lastName", type="string", maxLength=XHRM\Recruitment\Api\CandidateAPI::PARAMETER_RULE_NAME_MAX_LENGTH),
     *             @OA\Property(property="email", type="string"),
     *             @OA\Property(property="contactNumber", type="string"),
     *             @OA\Property(property="vacancyId", type="integer"),
     *             @OA\Property(property="keywords", type="string", maxLength=XHRM\Recruitment\Api\CandidateAPI::PARAMETER_RULE_KEYWORDS_MAX_LENGTH),
     *             @OA\Property(property="comment", type="string", maxLength=XHRM\Recruitment\Api\CandidateAPI::PARAMETER_RULE_COMMENT_MAX_LENGTH),

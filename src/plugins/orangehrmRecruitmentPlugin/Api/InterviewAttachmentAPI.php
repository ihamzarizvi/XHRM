...
use XHRM\Recruitment\Api\Model\InterviewAttachmentModel;
use XHRM\Recruitment\Dto\InterviewAttachmentSearchFilterParams;
...
class InterviewAttachmentAPI extends Endpoint implements CrudEndpoint
{
     ...
     *                 property="comment",
     *                 type="string",
     *                 maxLength=XHRM\Recruitment\Api\InterviewAttachmentAPI::PARAM_RULE_COMMENT_MAX_LENGTH
     *             ),
     ...
     *                 type="string",
     *                 maxLength=XHRM\Recruitment\Api\InterviewAttachmentAPI::PARAM_RULE_CURRENT_ATTACHMENT_MAX_LENGTH
     *             ),
     *             @OA\Property(property="attachment", ref="#/components/schemas/Base64Attachment"),
     *             @OA\Property(
     *                 property="comment",

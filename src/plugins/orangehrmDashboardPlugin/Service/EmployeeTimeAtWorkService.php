...
use XHRM\Dashboard\Dao\EmployeeTimeAtWorkDao;
use XHRM\Dashboard\Dto\TimeAtWorkLastActionDetails;
use XHRM\Entity\AttendanceRecord;
use XHRM\Pim\Traits\Service\EmployeeServiceTrait;
use XHRM\Time\Service\TimesheetPeriodService;
            ...
            foreach ($attendanceRecords as $attendanceRecord) {
                ...
                if ($attendanceRecord->getState() === self::STATE_PUNCHED_OUT) {
                    ...
                    if ($punchInUtcDateTime < $startUTCDateTime && $punchOutUtcDateTime > $endUTCDateTime) {
                        ...
                        $punchInUtcDateTime < $startUTCDateTime && $endUTCDateTime > $punchOutUtcDateTime
                        ...
                        $startUTCDateTime < $punchInUtcDateTime && $punchInUtcDateTime < $endUTCDateTime

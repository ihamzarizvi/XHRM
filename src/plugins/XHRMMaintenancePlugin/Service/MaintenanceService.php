...
use XHRM\Maintenance\AccessStrategy\AccessStrategy;
use XHRM\Maintenance\Dao\MaintenanceDao;
...
class MaintenanceService
{
    ...
    public function getAccessStrategy(
        ...
        $accessStrategy = 'XHRM\Maintenance\AccessStrategy' . "\\" . $strategy . "AccessStrategy";

...
use XHRM\Entity\Decorator\AttendanceRecordDecorator;
...
class AttendanceRecord
{
     ...
     * @var Employee
     *
     * @ORM\ManyToOne(targetEntity="XHRM\Entity\Employee", inversedBy="attendanceRecords", cascade={"persist", "remove"})

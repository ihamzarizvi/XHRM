...
namespace XHRM\Attendance\Menu;
...
class EditMyAttendanceRecordMenuConfigurator implements MenuConfigurator
{
    ...
    public function configure(Screen $screen): ?MenuItem
    {
        ...
        $this->getCurrentModuleAndScreen()->overrideScreen('viewMyAttendanceRecord');
        return null;
    }
}

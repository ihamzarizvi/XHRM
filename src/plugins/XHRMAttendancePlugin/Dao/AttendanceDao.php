...
namespace XHRM\Attendance\Dao;

use DateTime;
use Doctrine\ORM\Query\Expr;
use Doctrine\ORM\QueryBuilder;
use XHRM\Attendance\Dto\AttendanceRecordSearchFilterParams;
use XHRM\Attendance\Dto\EmployeeAttendanceSummarySearchFilterParams;
...
class AttendanceDao extends BaseDao
{
    ...
    {
        return $this->getRepository(Employee::class)->findOneBy(['empNumber' => $empNumber]);
    }
}

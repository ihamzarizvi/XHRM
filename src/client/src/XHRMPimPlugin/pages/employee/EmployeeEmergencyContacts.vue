...
import SaveEmergencyContact from '@/XHRMPimPlugin/components/SaveEmergencyContact';
import EditEmergencyContact from '@/XHRMPimPlugin/components/EditEmergencyContact';

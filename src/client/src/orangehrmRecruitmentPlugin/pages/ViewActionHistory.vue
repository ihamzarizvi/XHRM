...
import CandidateActionLayout from '@/XHRMRecruitmentPlugin/components/CandidateActionLayout.vue';
import InterviewerAutocomplete from '@/XHRMRecruitmentPlugin/components/InterviewerAutocomplete.vue';

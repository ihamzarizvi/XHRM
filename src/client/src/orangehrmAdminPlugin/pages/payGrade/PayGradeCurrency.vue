...
<script>
import InlineActionButton from '@/XHRMAdminPlugin/components/InlineActionButton.vue';
import {APIService} from '@ohrm/core/util/services/api.service';
import usePaginate from '@ohrm/core/util/composable/usePaginate';
import SavePayCurrency from '@/XHRMAdminPlugin/pages/payGrade/SavePayCurrency.vue';
import EditPayCurrency from '@/XHRMAdminPlugin/pages/payGrade/EditPayCurrency.vue';
